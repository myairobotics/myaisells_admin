...
ENV NEXT_PUBLIC_PROD_URL=https://pre-production.myairesource.us
ENV NEXT_PUBLIC_DEMO_URL=https://pre-production.myairesource.us
ENV NEXT_PUBLIC_STAGING_URL=https://pre-production.myairesource.us
